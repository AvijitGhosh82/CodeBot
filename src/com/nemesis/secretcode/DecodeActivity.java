...
@SuppressLint("NewApi")
public class DecodeActivity extends SherlockActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mButton = (Button)findViewById(R.id.decodeBut);
		mEdit = (EditText)findViewById(R.id.decodeinput);
		mKey = (EditText)findViewById(R.id.decodekey);
		mButton.setOnClickListener(
				...
				public void onClick(View view)
				{
			        ...
			        EditText text = (EditText) findViewById(R.id.decodeoutput);
			        text.setText(fin);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getSupportMenuInflater().inflate(R.menu.activity_decode, menu);
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_refresh:
			Intent i = new Intent(DecodeActivity.this,DecodeActivity.class);
			startActivity(i);
			finish();
            return true;
		case R.id.menu_copy:
			EditText mout = (EditText)findViewById(R.id.decodeoutput);
	...
	{
		SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(DecodeActivity.this);
		theme = sharedPreferences.getInt("Theme",R.style.AppTheme);
		this.getApplicationContext().setTheme(theme);
	}
	
	public void decodeSend(View view) {
